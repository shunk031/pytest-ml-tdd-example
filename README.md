...
本リポジトリは、[`「テストを書かない研究者に送る “最初にテストを書く” 実験コード入門 – オレオレ最強 main.py から抜け出すために –」`](https://speakerdeck.com/shunk031/lets-start-your-ml-project-by-writing-tests) のサンプルコードです。「**オレオレ最強 main.py**」のスタイル（手続き的で密結合、依存が隠蔽されている）から脱却し、筋の良い Python コードを書く助けになれれば幸いです。
